import yaml
from .flash_info import FLASH_INFO_STR


class FlashConfig(object):
    def __init__(self) -> None:
        # self.cfg_file_path = "./flash_info.yml"
        self.cfg_file_str = FLASH_INFO_STR
    ...
    def flash_status_reg_read_code(self) -> list:
        if type(self.flash_info[7]) is list:
    ...
    def flash_status_reg_write_code(self) -> list:
        if type(self.flash_info[8]) is list:
