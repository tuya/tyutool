...
describe("fetchLatestJson (browser mode)", () => {
  ...
  it("throws on HTTP error", async () => {
    ...
    const { fetchLatestJson } = await import("./update-sources");
    await expect(
      fetchLatestJson("https://example.com/latest.json"),
